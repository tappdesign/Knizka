...
import pk.tappdesign.knizka.models.misc.PlayStoreMetadataFetcherResult;
import pk.tappdesign.knizka.utils.ConnectionManager;
import pk.tappdesign.knizka.utils.MiscUtils;
        ...
        .onPositive(new MaterialDialog.SingleButtonCallback() {
          ...
          public void onClick (@NonNull MaterialDialog dialog, @NonNull DialogAction which) {
            if (MiscUtils.isGooglePlayAvailable(mActivity)) {
              ((Knizka) mActivity.getApplication()).getAnalyticsHelper().trackEvent(
