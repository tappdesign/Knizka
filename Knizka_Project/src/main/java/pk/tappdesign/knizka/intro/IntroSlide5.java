...
public class IntroSlide5 extends IntroFragment {
  ...
  public void onActivityCreated (Bundle savedInstanceState) {
    ...
    binding.introTitle.setText(R.string.app_tour_listactivity_reminders_title);
    binding.introImage.setImageResource(R.drawable.slide5);
    binding.introDescription.setText(R.string.app_tour_listactivity_reminders_detail);
  }
}
