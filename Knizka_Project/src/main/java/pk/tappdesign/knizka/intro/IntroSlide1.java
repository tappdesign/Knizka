...
public class IntroSlide1 extends IntroFragment {
  ...
  public void onActivityCreated (Bundle savedInstanceState) {
    ...
    binding.introTitle.setText(R.string.app_tour_listactivity_intro_title);
    binding.introImage.setImageResource(R.drawable.slide1);
   // binding.introImage.setVisibility(View.GONE);
   // binding.introImageSmall.setImageResource(R.drawable.slide1);
   // binding.introImageSmall.setVisibility(View.VISIBLE);
    binding.introDescription.setText(R.string.app_tour_listactivity_intro_detail);
  }
}
