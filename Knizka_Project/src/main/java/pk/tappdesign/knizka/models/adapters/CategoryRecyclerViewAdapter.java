...
public class CategoryRecyclerViewAdapter extends RecyclerView.Adapter<CategoryViewHolder> {
  ...
  public void onBindViewHolder (@NonNull CategoryViewHolder holder, int position) {
    ...
    if (isSelected(position)) {
      ...
      holder.txtTitle.setTextColor(MaterialColors.getColor(holder.txtTitle, R.attr.themeDrawerTextSelected));
    } else {
      holder.txtTitle.setTypeface(null, Typeface.NORMAL);
      holder.txtTitle.setTextColor(MaterialColors.getColor(holder.txtTitle, R.attr.themeDrawerText));
    }
